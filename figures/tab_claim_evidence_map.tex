...
Case retrieval provides inspectable evidence when the policy keeps retrieval active. & \Cref{tab:decision-trace-examples,fig:warning-score-evidence-alignment,tab:knowledge-grounded-evidence,tab:case-evidence-utility,tab:blinded-expert-evidence-rating,tab:blinded-expert-dataset-breakdown,tab:atlasv2-review-augmentation,tab:alert-stability-audit} & High-score warnings often surface semantically anchored train-only analogs; blinded raters give TRACER higher overall actionability and explanation-quality scores, with regime-dependent evidence preferences. & Deployment-level SOC triage gain, universal human-rated evidence dominance, or an independent top-budget ranking boost from analog labels alone. \\
